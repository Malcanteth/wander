...
const
  ...
  LiquidState: array [1 .. LiquidStateAmount] of string = ('густой', 'газированой', 'вонючей', 'ароматной', 'булькающей');

  { Цвет жидкости }
  LiquidColor: array [1 .. crAmount] of string = ('сияющей', 'синей', 'зеленой', 'красной', 'голубой', 'фиолетовой', 'коричневой', 'белой', 'серой',
    'желтой', 'светло-серой', 'светло-красной', 'светло-зеленой', 'светло-синей', 'оранжевой', 'морской', 'лазуритовой', 'огненной', 'изумрудной');
        ...
        begin
          ...
          begin
            ...
            begin
              case Random(3) + 1 of
                1:
                  AddMsg('Ммм... Тебе понравилось!', 0);
                2:
                  AddMsg('Пххх.. Отдаёт спиртом...', 0);
                3:
                  AddMsg('Ты довольно быстро осушил{/a} бутылку до донышка. Не плохо. Освежает!', 0);
              end;
            end;
