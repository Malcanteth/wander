...
begin
  ...
  begin
    ...
    case id of
        ...
        mdMALECITIZEN, mdFEMALECITIZEN, mdBREAKMT, mdDRUNK, mdKEYWIFE, mdHEALER, mdBARTENDER: // Жители деревушки
          // Выполняем скрипт
          Run('NPCTalk.pas');
        ...
        begin
          ...
          case pc.quest[1] of
            ...
            begin
              ...
              More;
              AddMsg(MonstersData[id].name1 + ' говорит: "Здравствуй, '+pc.name+'! Меня зовут '+name+'. Я старейшина Эвилиара и у меня есть к тебе просьба."',0); More;
            ...
            begin
              AddMsg(MonstersData[id].name3+', пожав тебе руку, сказал:',0); More;
            ...
            begin
              ...
              case pc.quest[2] of
                0 :
                begin
                  AddMsg(FullName(1, TRUE) + ' говорит: "Ну что, я вижу ты готов{/а} для нового задания. А дело вот в чем..."',0); More;
