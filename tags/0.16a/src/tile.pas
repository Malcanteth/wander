...
const
  ...
  (
    ...
    (name: 'Вода';           hardy: TRUE;  void: TRUE;  blood: FALSE; move: FALSE; important: FALSE; char: '='; color: crBLUE),
    (name: 'Странный пол красного цвета';  hardy: FALSE;void: TRUE;  blood: TRUE; move: TRUE; important: FALSE; char: '.'; color: crLIGHTRED),
    (name: 'Раскаленная стена';            hardy: TRUE; void: FALSE; blood: TRUE; move: FALSE; important: FALSE; char: '#'; color: crLIGHTRED),
