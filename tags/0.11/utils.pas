...
function HeroHS(situation : byte) : string;      // Вернуть окончание в зависимости от пола героя
...
function HeroHS(situation : byte) :string;
begin
  case situation of
    1 :
    case pc.gender of
